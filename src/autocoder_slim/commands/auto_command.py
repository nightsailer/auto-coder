...
from autocoder_slim.common import detect_env
from autocoder_slim.common import shells
from loguru import logger
from autocoder_slim.utils import llms as llms_utils
from autocoder_slim.rag.token_counter import count_tokens
from autocoder_slim.common.global_cancel import global_cancel,CancelRequestedException
...
from autocoder_slim.common.mcp_server import get_mcp_server, McpServerInfoRequest
...
class CommandAutoTuner:
    ...
    def analyze(self, request: AutoCommandRequest) -> AutoCommandResponse:
        ...
        if last_meta:
            ...
            from autocoder_slim.utils import llms as llm_utils
        ...
        while True:
            ...
            if last_result:
                ...
                if total_tokens > self.args.conversation_prune_safe_zone_tokens:
                    ...
                    from autocoder_slim.common.conversation_pruner import ConversationPruner
