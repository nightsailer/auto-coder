...
from autocoder_slim.common.result_manager import ResultManager
from autocoder_slim.version import __version__
from autocoder_slim.auto_coder import main as auto_coder_main
from autocoder_slim.utils import get_last_yaml_file
from autocoder_slim.commands.auto_command import CommandAutoTuner, AutoCommandRequest, CommandConfig, MemoryConfig
from autocoder_slim.common.v2.agent.agentic_edit import AgenticEdit,AgenticEditRequest
from autocoder_slim.common.v2.agent.agentic_edit_types import AgenticEditConversationConfig
from autocoder_slim.index.symbols_utils import (
    extract_symbols,
    SymbolType,
)
import platform
...
import git
from autocoder_slim.common import git_utils
from autocoder_slim.chat_auto_coder_lang import get_message,get_message_with_format
from autocoder_slim.agent.auto_guess_query import AutoGuessQuery
...
from autocoder_slim.common.memory_manager import get_global_memory_file_paths 
...
from autocoder_slim.utils.thread_utils import run_in_raw_thread
from autocoder_slim.memory.active_context_manager import ActiveContextManager
from autocoder_slim.common.command_completer import CommandCompleter,FileSystemModel as CCFileSystemModel,MemoryConfig as CCMemoryModel
from autocoder_slim.common.conf_validator import ConfigValidator
from autocoder_slim.common.ac_style_command_parser import parse_query
from loguru import logger as global_logger
from autocoder_slim.utils.project_structure import EnhancedFileAnalyzer
from autocoder_slim.common import SourceCodeList,SourceCode
from autocoder_slim.common.file_monitor import FileMonitor
from filelock import FileLock
from autocoder_slim.common.command_file_manager import CommandManager
...
def load_tokenizer():
    from autocoder_slim.rag.variable_holder import VariableHolder
...
def init_singleton_instances():
    ...
    # 初始化忽略文件管理器
    from autocoder_slim.common.ignorefiles.ignore_file_utils import IgnoreFileManager
...
def initialize_system(args:InitializeSystemRequest):
    from autocoder_slim.utils.model_provider_selector import ModelProviderSelector
    from autocoder import models as models_module
...
from autocoder_slim.common.command_completer_v2 import CommandCompleterV2
...
def convert_yaml_to_config(yaml_file: str):
    from autocoder_slim.auto_coder import AutoCoderArgs, load_include_files, Template
...
@run_in_raw_thread()
def rules(query: str):
    from autocoder_slim.chat.rules_command import handle_rules_command
    memory = get_memory()
...
def manage_models(query: str):
    ...
    if subcmd == "/list":                    
        ...
        from autocoder_slim.common.model_speed_tester import render_speed_test_in_terminal
...
def help(query: str):
    from autocoder_slim.common.auto_configure import ConfigAutoTuner,MemoryConfig,AutoConfigRequest        
    args = get_final_config()
    product_mode = memory.get("product_mode", "lite")
    llm = get_single_llm(args.chat_model or args.model, product_mode=product_mode)
...
def index_export(path: str):
    from autocoder_slim.common.index_import_export import export_index
    from autocoder_slim.common.printer import Printer
    printer = Printer()
    project_root = os.getcwd()
...
def index_import(path: str):
    from autocoder_slim.common.index_import_export import import_index
    from autocoder_slim.common.printer import Printer
    printer = Printer()
    project_root = os.getcwd()
...
def index_query(query: str):
    from autocoder_slim.index.entry import build_index_and_filter_files
    from autocoder_slim.pyproject import PyProject
    from autocoder_slim.tsproject import TSProject
    from autocoder_slim.suffixproject import SuffixProject
...
def execute_shell_command(command: str):
    from autocoder_slim.common.shells import execute_shell_command as shell_exec
    shell_exec(command)


def conf_export(path: str):
    from autocoder_slim.common.conf_import_export import export_conf
    export_conf(os.getcwd(), path)

def conf_import(path: str):
    from autocoder_slim.common.conf_import_export import import_conf
...
def auto_command(query: str,extra_args: Dict[str,Any]={}):    
    ...
    if args.enable_agentic_edit:        
        from autocoder_slim.run_context import get_run_context,RunMode
