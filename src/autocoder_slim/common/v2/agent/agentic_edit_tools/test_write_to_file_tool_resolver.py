...
from autocoder_slim.common.v2.agent.agentic_edit_types import WriteToFileTool, ToolResult
from autocoder_slim.common.v2.agent.agentic_edit_tools.write_to_file_tool_resolver import WriteToFileToolResolver
from autocoder_slim.auto_coder_runner import load_tokenizer as load_tokenizer_global
from autocoder_slim.utils.llms import get_single_llm
from autocoder_slim.common.file_monitor.monitor import get_file_monitor, FileMonitor
from autocoder_slim.common.rulefiles.autocoderrules_utils import get_rules, reset_rules_manager
...
def mock_agent_with_shadow(test_args, temp_test_dir):
    ...
    from autocoder_slim.shadows.shadow_manager import ShadowManager
    from autocoder_slim.linters.shadow_linter import ShadowLinter
