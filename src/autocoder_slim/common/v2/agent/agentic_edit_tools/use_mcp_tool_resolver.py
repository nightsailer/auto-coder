...
from autocoder_slim.common.mcp_server_types import McpRequest
from autocoder_slim.common.v2.agent.agentic_edit_tools.base_tool_resolver import BaseToolResolver
from autocoder_slim.common.v2.agent.agentic_edit_types import UseMcpTool, ToolResult # Import ToolResult from types
