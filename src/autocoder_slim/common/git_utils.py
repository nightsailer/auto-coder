...
def generate_commit_message(changes_report: str) -> str:
    ...
    +    "import tempfile\n",
    +    "from loguru import logger\n",
    +    "from autocoder_slim.rag.long_context_rag import LongContextRAG\n",
    +    "from autocoder_slim.rag.rag_config import RagConfig\n",
    +    "from autocoder_slim.rag.cache.simple_cache import AutoCoderRAGAsyncUpdateQueue\n",
    ...
    from autocoder_slim.common.types import Mode
    from autocoder_slim.common import AutoCoderArgs
    import byzerllm
    +from autocoder_slim.utils.queue_communicate import queue_communicate, CommunicateEvent, CommunicateEventType
