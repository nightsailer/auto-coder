...
from autocoder_slim.common.file_checkpoint.utils import (
    apply_shadow_changes, undo_last_changes, get_change_history
)
from autocoder_slim.common.file_checkpoint.models import FileChange
from autocoder_slim.common.file_checkpoint.manager import FileChangeManager
...
class TestUndoLastChanges:
    ...
    def test_undo_with_error(self, temp_test_dir):
        ...
        with patch.object(FileChangeManager, 'undo_last_change') as mock_undo:
            from autocoder_slim.common.file_checkpoint.models import UndoResult
...
class TestGetChangeHistory:
    ...
    def test_get_history_with_limit(self, temp_test_dir):
        ...
        with patch.object(FileChangeManager, 'get_change_history') as mock_get_history:
            # 创建模拟的返回值
            from autocoder_slim.common.file_checkpoint.models import ChangeRecord
            mock_records = [
