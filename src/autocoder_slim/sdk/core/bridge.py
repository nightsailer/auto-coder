...
class AutoCoderBridge:
    ...
    def _setup_environment(self):
        ...
        try:
            ...
            try:
                ...
                from autocoder_slim.auto_coder_runner import start                
                start()
            except ImportError:
                # 如果无法导入，跳过初始化
                pass
    ...
    def init_project_if_required(self):
        from autocoder_slim.auto_coder_runner import init_project_if_required as init_project_if_required_buildin
    ...
    def get_memory(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                from autocoder_slim.auto_coder_runner import get_memory
    ...
    def save_memory(self, memory_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            try:
                from autocoder_slim.auto_coder_runner import save_memory, memory
                # 更新全局 memory 变量
    ...
    def get_project_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                from autocoder_slim.auto_coder_runner import get_final_config
    ...
    def cleanup(self) -> None:
        ...
        try:
            ...
            try:
                from autocoder_slim.auto_coder_runner import stop
                stop()
            except ImportError:
                pass
